...
import { faHome, faUser, faSchool } from '@fortawesome/free-solid-svg-icons';
import { log } from "console";



const SidebarTutor: React.FC = () => {
  const { logout, token, user } = useGlobalState();
  return (
    <div>
      <aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          <Link to='profile' className="flex items-center mb-5 justify-center gap-5">
            ...
            <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">{`${user?.first_name}`}</span>
          </Link>
